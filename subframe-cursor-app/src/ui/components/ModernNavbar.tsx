...
/*
 * Documentation:
 * Modern navbar — https://app.subframe.com/34785dc44752/library?component=Modern+navbar_cba8555a-1e5a-4a57-8c3d-6ad67c2ef976
...
const ModernNavbarRoot = React.forwardRef<HTMLElement, ModernNavbarRootProps>(
  function ModernNavbarRoot(
    ...
    return (
      <div
        className={SubframeUtils.twClassNames(
          "group/cba8555a flex w-full max-w-[1024px] flex-wrap items-center gap-4 rounded-md border border-solid border-neutral-border bg-default-background shadow-md",
          className
        )}
        ref={ref as any}
        {...otherProps}
      >
        ...
        <div className="flex min-w-[320px] grow shrink-0 basis-0 flex-wrap items-center gap-6">
          <NavItem className="hidden">Product</NavItem>
          <NavItem>Features</NavItem>
          <NavItem>Pricing</NavItem>
          <NavItem className="hidden">About</NavItem>
          <NavItem className="hidden">Changelog</NavItem>
          <NavItem className="hidden">Contact</NavItem>
        </div>
